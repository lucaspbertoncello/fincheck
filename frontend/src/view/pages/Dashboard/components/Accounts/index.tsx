          ...
          <div className="flex flex-1 flex-col justify-end">
            ...
            {accounts.length === 0 && (
              <>
                ...
                <button className="mt-4 flex h-52 w-full cursor-pointer flex-col items-center justify-center gap-4 rounded-2xl border-2 border-dashed border-teal-600 text-white">
