    ...
    <Modal open={open} onClose={onClose} title="Filtros">
      <div>
        ...
        <div className="mt-2 space-y-2">
          <button className="w-full cursor-pointer rounded-2xl !bg-gray-200 p-2 text-left text-gray-800 transition-colors hover:bg-gray-50">
            Nubank
          </button>

          <button className="w-full cursor-pointer rounded-2xl p-2 text-left text-gray-800 transition-colors hover:bg-gray-50">
            Santander
          </button>
      ...
      <div className="mt-10 text-gray-800">
        ...
        <div className="mt-2 flex w-52 items-center justify-between">
          <button className="grid h-12 w-12 cursor-pointer place-items-center">
